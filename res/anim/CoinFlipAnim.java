...
public class CoinFlipAnim extends Transition {
    ...
    protected void interpolate(double frac) {
        if (frac < 0.166666666) {
            coin.setImage(coinImgs[0]);
        }

        if (frac >= 0.166666666 && frac < 0.33333333) {
            coin.setImage(coinImgs[1]);
        }

        if (frac >= 0.33333333 && frac < 0.499999999) {
            coin.setImage(coinImgs[2]);
        }

        if (frac >=  0.499999999 && frac < 0.666666666) {
            coin.setImage(coinImgs[3]);
        }

        if (frac >=  0.666666666 && frac < 0.833333333) {
            coin.setImage(coinImgs[4]);
        }

        if (frac >=  0.833333333 && frac < 1.0) {
            coin.setImage(coinImgs[5]);
        }
